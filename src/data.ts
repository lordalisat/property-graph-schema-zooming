...
for (let i = 0; i <= 4; i++) {
  ...
  graph.edgeEdges.push(SimpleGraphEdge.edgeEdge(edge, startNode, EdgeDirection.from));
  graph.edgeEdges.push(SimpleGraphEdge.edgeEdge(edge, endNode, EdgeDirection.to));
}
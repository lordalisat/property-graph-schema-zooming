...
export class PropertyGraphEdge extends PropertyGraphElement {
  ...
  static fromJSON(element: { id: string, source: string, target: string, isDirected: boolean, labels: Array<string>, properties: Record<string, string | boolean | number> }): PropertyGraphEdge {
  ...
  public toJSON(): { id: string, source: string, target: string, isDirected: boolean, labels: Array<string>, properties: Record<string, string | boolean | number> } {
